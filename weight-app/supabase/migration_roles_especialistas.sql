...
-- Distinción recomendación vs receta (columna adicional, no rompe nada existente)
alter table recipes add column if not exists type text not null default 'recomendacion';
